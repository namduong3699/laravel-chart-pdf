...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ public_path('css/common.css') }}">
    ...
    <body>
        <div style="width: 1202px; height: 933px; background-color: white;" class="export">
            <main class="page position-relative">
                ...
                <div class="page__logo position-absolute bg-white">
                    <img src="{{ public_path('images/logo.png') }}" alt="Logo.png" srcset="">
                </div>
            </main>
        </div>
        ...
        <script>
            ...
            const colorAxisWidth = 30,
                ...
                thresholds = {
                    acceptable: {!! $data['thresholds']['acceptable'] !!},
                    danger: {!! $data['thresholds']['danger'] !!},
                };
